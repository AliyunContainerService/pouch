...
func setupFlags(cmd *cobra.Command) {
	...
	flagSet.BoolVar(&cfg.IsCriEnabled, "enable-cri", false, "Specify whether to enable the cri part of pouchd which is used to support Kubernetes")
	...
	flagSet.BoolVar(&cfg.CriConfig.ServerTLS, "server-tls", false, "Specify whether to enable https server of cri stream server")
